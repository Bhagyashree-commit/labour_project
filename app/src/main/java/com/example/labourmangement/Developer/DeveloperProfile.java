...
SessionForDeveloper sessionForDeveloper;
    String[] SPINNERWORKINGHOUR = {"ARCHITECT","ENGINEER","CONTRACTOR","LABOURER"};
    ...
    private void savedata(){
        ...
        // email
        String email = user.get(SessionForDeveloper.KEY_EMAIL);
        String role =user.get(SessionForDeveloper.KEY_ROLE);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConfig.URL_INSERTCONTRACTORDATA,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(DeveloperProfile.this).create();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                            ...
                            Toast.makeText(DeveloperProfile.this, "Connection Time Out.. Please Check Your Internet Connection", duration).show();
                            ...
                            loader.dismiss();
                            int duration = Toast.LENGTH_SHORT;
                            Toast.makeText(DeveloperProfile.this, "Your Are Not Authrized..", duration).show();
                            ...
                            int duration = Toast.LENGTH_SHORT;
                            Toast.makeText(DeveloperProfile.this, "Server Error", duration).show();
                            //TODO
                            ...
                            int duration = Toast.LENGTH_SHORT;
                            Toast.makeText(DeveloperProfile.this, "Please Check Your Internet Connection", duration).show();
                            //TODO
                            ...
                            int duration = Toast.LENGTH_SHORT;
                            Toast.makeText(DeveloperProfile.this, "Error While Data Parsing", duration).show();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("role", user.get(SessionForDeveloper.KEY_ROLE));
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DeveloperProfile.this);
