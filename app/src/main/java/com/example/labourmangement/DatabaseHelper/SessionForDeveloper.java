...
public class SessionForDeveloper {
    // LogCat tag
    private static String TAG = com.example.labourmangement.DatabaseHelper.SessionForDeveloper.class.getSimpleName();
    ...
    private static final String PREF_NAME = "LabourManagementdeveloper";
    ...
    public SessionForDeveloper(Context context) {
    ...
    public void checkLogin(){
        ...
        if(!this.isLoggedIn()){
            ...
            Intent i = new Intent(_context, UpdateMain.class);
    ...
    //=====
    public SessionForDeveloper commit() {
        editor.commit();
        return this;
    }

    //=====
    public SessionForDeveloper set(String key, String value) {
