...
public class SessionForEngineer {
    // LogCat tag
    private static String TAG = com.example.labourmangement.DatabaseHelper.SessionForEngineer.class.getSimpleName();
    ...
    private static final String PREF_NAME = "LabourManagementEngineer";
    ...
    public SessionForEngineer(Context context) {
    ...
    //=====
    public SessionForEngineer commit() {
        editor.commit();
        return this;
    }

    //=====
    public SessionForEngineer set(String key, String value) {
