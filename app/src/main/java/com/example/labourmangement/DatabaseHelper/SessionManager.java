...
public class SessionManager {
    ...
    private static final String PREF_NAME = "LabourManagement";

    private static final String KEY_IS_LOGGEDIN = "isLoggedIn";
    private static final String KEY_IS_NOT_LOGGEDIN = "isNotLoggedIn";
    ...
    //=====
    public SessionManager commit() {
        editor.commit();
        return this;
    }

    //=====
    public SessionManager set(String key, String value) {
    ...
    public boolean isNotLoggedIn(){
        return pref.getBoolean(KEY_IS_NOT_LOGGEDIN, true);
    }
