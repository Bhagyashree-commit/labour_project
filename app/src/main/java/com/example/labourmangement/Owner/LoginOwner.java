...
TextView alrreadyuser,forgetpass;
Button loginowner;
    private static final String TAG = LoginOwner.class.getSimpleName();
...
CustomLoader loader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().hide();
        alrreadyuser=findViewById(R.id.text_newownerusernewlodin);
        loginowner=findViewById(R.id.btnloginowner);
        forgetpass=findViewById(R.id.forgetpass);
        edit_name = (EditText) findViewById(R.id.et_loginownermobilenumber);
        edit_password = (EditText) findViewById(R.id.et_loginownerpassword);

        forgetpass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                sessionown.set("Page","OwnLogin");
                sessionown.commit();
                Intent intent = new Intent(LoginOwner.this, ForgetPassword.class);
        ...
        HashMap<String, String> user = sessionown.getUserDetails();
        ...
        if (sessionown.isLoggedIn()) {
            ...
            Intent intent = new Intent(LoginOwner.this, OwnerDashboard.class);
            startActivity(intent);
            finish();
        }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        sessionown.createUserLoginSession(email,name,role,refcode,refname);

                        sessionown.setLogin(true,email);


                        // Launch main activity
                        Intent intent = new Intent(LoginOwner.this,
            ...
            public void onErrorResponse(VolleyError error) {
                if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                   ...
                   loader.dismiss();
                    ...
                    Toast.makeText(LoginOwner.this, "Connection Time Out.. Please Check Your Internet Connection", duration).show();
                } else if (error instanceof AuthFailureError) {
                    //TODO
                    System.out.println("AuthFailureError.........................." + error);
                    loader.dismiss();
                    int duration = Toast.LENGTH_SHORT;
                    Toast.makeText(LoginOwner.this, "Your Are Not Authrized..", duration).show();
                } else if (error instanceof ServerError) {
                    System.out.println("server erroer......................." + error);
                    loader.dismiss();

                    int duration = Toast.LENGTH_SHORT;
                    Toast.makeText(LoginOwner.this, "Server Error", duration).show();
                    //TODO
                    ...
                    int duration = Toast.LENGTH_SHORT;
                    Toast.makeText(LoginOwner.this, "Please Check Your Internet Connection", duration).show();
                    //TODO
                    ...
                    int duration = Toast.LENGTH_SHORT;
                    Toast.makeText(LoginOwner.this, "Error While Data Parsing", duration).show();
